...
def _register_builtins() -> None:
    ...
    from prophet.strategies.straddle_strategy import ALL_STRADDLE_CLASSES
    from prophet.strategies.contra_srb_strategy import ALL_CONTRA_SRB_CLASSES
